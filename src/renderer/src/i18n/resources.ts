  ...
  en: {
    translation: {
      ...
      compression: {
        ...
        passwordNotice7z: 'AES-256 encryption will be used.',
        encryptHeaders: 'Hide the file list too',
        encryptHeadersHint: 'Names inside the archive stay unreadable without the password.',
  ...
  ko: {
    translation: {
      ...
      compression: {
        ...
        passwordNotice7z: 'AES-256 암호화가 적용됩니다.',
        encryptHeaders: '파일 목록도 숨기기',
        encryptHeadersHint: '비밀번호 없이는 압축 파일 안의 이름도 볼 수 없습니다.',
