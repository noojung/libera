  ...
  en: {
    translation: {
      ...
      compression: {
        ...
        levelNone: '{{level}} - No compression (fastest)',
        levelFast: '{{level}} - Fast compression',
        levelBalanced: '{{level}} - Balanced',
        levelMaximum: '{{level}} - Maximum compression',
  ...
  ko: {
    translation: {
      ...
      compression: {
        ...
        format: '압축 포맷 선택',
        level: '압축 강도 레벨',
        levelNone: '{{level}} - 압축 없음 (가장 빠름)',
        levelFast: '{{level}} - 빠른 압축',
        levelBalanced: '{{level}} - 균형 표준',
        levelMaximum: '{{level}} - 최대 압축',
