  ...
  en: {
    translation: {
      ...
      compression: {
        ...
        passwordNotice: 'Compatibility-focused ZIP encryption will be used. It is not recommended for strong confidentiality.',
  ...
  ko: {
    translation: {
      ...
      compression: {
        ...
        zipPassword: 'ZIP 비밀번호',
        optional: '(선택)',
        passwordPlaceholder: '비밀번호 입력',
        confirmPasswordPlaceholder: '비밀번호 확인',
        passwordMismatch: '비밀번호가 일치하지 않습니다.',
        passwordNotice: 'ZIP 호환용 암호화가 적용됩니다. 강한 기밀 보호 용도로는 권장하지 않습니다.',
